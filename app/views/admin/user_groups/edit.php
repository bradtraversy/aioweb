...
<?php $attributes = array('id' => 'edit_group_form'); ?>
<?php echo form_open('admin/user_groups/edit/'.$this_group->id,$attributes); ?>
 <div class="row">
          <div class="col-lg-6">
            <h1>Edit Group <small></small></h1>
          </div>
            <div class="col-lg-6">
		...
		<form role="form">	
          ...
          <div class="form-group">
						  ...
						  <input class="form-control" type="text" name="group_title" id="group_title" placeholder="Enter Group Title" value="<?php echo $this_group->title; ?>" />
					</div>
              	</div>
		  		<div class="col-lg-6">					
          		</div>
