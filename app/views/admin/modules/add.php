...
<?php echo form_open('admin/modules/add',$attributes); ?>
<div class="row">
          <div class="col-lg-6">
            <h1>Add New Module <small></small></h1>
          </div>
            <div class="col-lg-6">
		...
		<div class="row">
            <div class="col-lg-12">
			  ...
			  <li class="active"><i class="fa fa-plus-square-o"></i> New Module</li>
            </ol>
            </div>  
        </div>
        	...
        	<div class="row">
          		<div class="col-lg-6">
            		<div class="form-group">
						...
						<input class="form-control" type="text" name="module_title" id="module_title" value="<?php echo set_value('module_title'); ?>" placeholder="Enter Module Title" />
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<textarea class="form-control" type="text" name="module_content" id="module_content" placeholder="Enter Module Content" rows="10"><?php echo set_value('module_content'); ?></textarea>
					</div>
					 <div class="form-group">
