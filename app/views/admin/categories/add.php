...
<?php echo form_open('admin/categories/add',$attributes); ?>
 <div class="row">
          <div class="col-lg-6">
            <h1>Add New Category <small></small></h1>
          </div>
            <div class="col-lg-6">
		...
		<form role="form">	
          ...
          <div class="form-group">
						  ...
						  <input class="form-control" type="text" name="category_title" id="category_title" placeholder="Enter Category" value="<?php echo set_value('category_title'); ?>" />
					</div>
          <div class="form-group">
              <label for="category_slug">Category Slug</label>
              <input class="form-control" type="text" name="category_slug" id="category_slug" placeholder="Enter Category Slug" value="<?php echo set_value('category_slug'); ?>" />
            <p class="help-block">URL friendly version of title. No caps or spaces, only hyphens</p>
          </div>
					<div class="form-group">
						<label for="category_description">Category Description</label>
						<textarea class="form-control" type="text" name="category_description" id="category_description" placeholder="Enter Category Description" rows="10"><?php echo set_value('category_description'); ?></textarea>
					</div>				
					<div class="form-group">
