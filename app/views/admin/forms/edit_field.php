...
<?php echo form_open('admin/forms/add_field/'.$this_form->id.'/'.$this_field->id,$attributes); ?>
 <div class="row">
          <div class="col-lg-6">
            <h1>Edit Field <small><?php echo $this_field->label; ?></small></h1>
          </div>
            <div class="col-lg-6">
                <div class="btn-group pull-right">
                    <input type="submit" name="submit" id="field_submit" class="btn btn-default" value="Save" />
                    <a href="<?php echo base_url(); ?>admin/forms/fields/<?php echo $this_form->id; ?>" class="btn btn-default">Close</a>
			</div>
          </div>
        </div><!-- /.row -->
		<div class="row">
            <div class="col-lg-12">
              ...
              <li><a href="<?php echo base_url(); ?>admin/forms/fields/<?php echo $this_form->id; ?>"><i class="fa fa-envelope"></i> Forms</a></li>
			  <li class="active"><i class="fa fa-pencil"></i> Edit Field</li>
            </ol>
            </div>  
        </div>
		<form role="form">	
        	<div class="row">
          		<div class="col-lg-6">
          			<div class="form-group">
						...
						<input class="form-control" type="text" name="field_label" id="field_label" placeholder="Enter Label" value="<?php echo $this_field->label; ?>" />
						<p class="help-block">&lt;label&gt; tag for this field</p>
					</div>
      				
      				<div class="form-group">
						<label for="field_name">Field Name</label>
						<input class="form-control" type="text" name="field_name" id="field_name" placeholder="Enter Name" value="<?php echo $this_field->name; ?>" />
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" name="field_width" id="field_width" placeholder="Enter Width in Pixels" value="<?php echo $this_field->width; ?>" />
						<p class="help-block">Optinal: Choose the width. Default is 200</p>
					</div>

					<div class="form-group">
						<label for="field_height">Field Height</label>
						<input class="form-control" type="text" name="field_height" id="field_height" placeholder="Enter Height in Pixels" value="<?php echo $this_field->height; ?>" />
