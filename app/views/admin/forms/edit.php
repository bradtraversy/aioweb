...
<?php echo form_open('admin/forms/edit/'.$this_form->id,$attributes); ?>
 <div class="row">
          <div class="col-lg-6">
            <h1>Edit Form <small><?php echo $this_form->title; ?></small></h1>
          </div>
            <div class="col-lg-6">
		...
		<div class="row">
            <div class="col-lg-12">
			  ...
			  <li class="active"><i class="fa fa-plus-square-o"></i> Edit Form</li>
            </ol>
            </div>  
        </div>
		<form role="form">	
        	<div class="row">
          		<div class="col-lg-6">
            		<div class="form-group">
						...
						<input class="form-control" type="text" name="form_title" id="form_title" value="<?php echo $this_form->title; ?>" placeholder="Enter Form Title" />
					</div>
					<div class="form-group">
						<label for="to_email">To Email</label>
						<input class="form-control" type="text" name="to_email" id="to_email" value="<?php echo $this_form->to_email; ?>" placeholder="Enter Email" />
						<p class="help-block">Email the form will go to</p>
					</div>
					 <div class="form-group">
						<label for="subject">Email Subject</label>
						<input class="form-control" type="text" name="subject" id="subject" value="<?php echo $this_form->subject; ?>" placeholder="Enter Subject" />
          ...
          <div class="form-group">
            ...
            <p class="help-block">Choose which modules will show on this page</p>
                    ...
                    <label for="is_published" class="radio-inline">
                      <input type="radio" name="is_published" id="is_published" value="1" <?php echo ($this_form->is_published== 1) ? 'checked' : ''; ?>> yes
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="is_published" id="is_published" value="0" <?php echo ($this_form->is_published == 0) ? 'checked' : ''; ?>> No
                    </label>
                	</div>
              	</div>
		  		...
		  		<div class="col-lg-6">
					...
					<div class="form-group">
						...
						<input class="form-control" type="text" name="order" id="order" style="width:50px;" value="<?php echo $this_item->order; ?>" />
           ...
           <div class="form-group">
                    ...
                    <label for="is_message" class="radio-inline">
                      <input type="radio" name="is_message" id="is_message" value="1" <?php echo ($this_form->is_message== 1) ? 'checked' : ''; ?>> yes
                    </label>
                    <label class="radio-inline">
                      <input type="radio" name="is_message" id="is_message" value="0" <?php echo ($this_form->is_message== 0) ? 'checked' : ''; ?>> no
                    </label>
